...
class SurveyRedirectionTest(TestCase):
    ...
    def test_show_survey(self):
        survey = Survey(title='A testing survey')
        survey.save()
        Question(body='A Question', kind=Question.TEXT, survey=survey).save()
    ...
    def test_redirect_to_first_question(self):
        ...
        question = Question(body='A Question', kind=Question.TEXT, survey=survey)
        question.save()
...
class SurveyResultsTest(TestCase):
    ...
    def test_render_context(self):
        ...
        question_one = Question(body='Question one', kind=Question.TEXT, survey=survey)
        question_one.save()
